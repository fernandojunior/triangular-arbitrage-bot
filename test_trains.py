from trains.trains import *

def test_create_graph():
  g = create_graph("AB5, BC4, CD8, DC8, DE6, AD5, CE2, EB3, AE7")
  assert g.nodes == {'C', 'D', 'E', 'B', 'A'}
  assert g.distances == {('A', 'D'): 5, ('E', 'B'): 3, ('D', 'C'): 8, ('D', 'E'): 6, ('C', 'E'): 2, ('A', 'E'): 7, ('C', 'D'): 8, ('B', 'C'): 4, ('A', 'B'): 5}
...
def test_run_route_len():
  ...
  #assert run_route_len2( g, start_node = "C", end_node="C", operator="<", min_dist = 30, return_amount=True, pathway = "C") == 7
  #assert route_verification("C->C, L<30", g) == 7
